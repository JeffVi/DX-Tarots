return {
    ...
    tarot_dx_rate = 0;--0.1               -- (from 0 (0%) to 1 (100%))
    tarot_cu_rate = 0;--0.07              -- (from 0 (0%) to 1 (100%))
    planet_dx_rate = 0;--0.12             -- (from 0 (0%) to 1 (100%))
    spectral_dx_rate = 0;--0.15           -- (from 0 (0%) to 1 (100%))
    alchemical_dx_rate = 0;--0.1          -- (from 0 (0%) to 1 (100%))
    booster_dx_rate = 0;--0.1             -- (from 0 (0%) to 1 (100%))
