...
-- For convenience
function CABooster:newDX(name, slug, config, pos, cost, discovered, weight, kind, atlas)
    ...
    return CABooster:new(name, slug, config, pos, cost, discovered, weight, kind, atlas)
end

-- Need a custom register to add DX boosters to the correct CENTER_POOL
function CABooster:registerDX()
...
function load_dx_alchemical_packs()
    ...
    CABooster:newDX("Alchemy Pack", "alchemy_normal_1", {extra = 3, choose = 1, unique = true}, { x = 0, y = 0 }, 6, false, 1, "Celestial", "ca_booster_dx_atlas"):registerDX()
    CABooster:newDX("Alchemy Pack", "alchemy_normal_2", {extra = 3, choose = 1, unique = true}, { x = 1, y = 0 }, 6, false, 1, "Celestial", "ca_booster_dx_atlas"):registerDX()
    CABooster:newDX("Alchemy Pack", "alchemy_normal_3", {extra = 3, choose = 1, unique = true}, { x = 2, y = 0 }, 6, false, 1, "Celestial", "ca_booster_dx_atlas"):registerDX()
    CABooster:newDX("Alchemy Pack", "alchemy_normal_4", {extra = 3, choose = 1, unique = true}, { x = 3, y = 0 }, 6, false, 1, "Celestial", "ca_booster_dx_atlas"):registerDX()
    CABooster:newDX("Jumbo Alchemy Pack", "alchemy_jumbo_1", {extra = 5, choose = 1, unique = true}, { x = 0, y = 1 }, 6, false, 1, "Celestial", "ca_booster_dx_atlas"):registerDX()
    CABooster:newDX("Jumbo Alchemy Pack", "alchemy_jumbo_2", {extra = 5, choose = 1, unique = true}, { x = 1, y = 1 }, 6, false, 1, "Celestial", "ca_booster_dx_atlas"):registerDX()
    CABooster:newDX("Mega Alchemy Pack", "alchemy_mega_1", {extra = 5, choose = 2, unique = true}, { x = 2, y = 1 }, 6, false, 0.25, "Celestial", "ca_booster_dx_atlas"):registerDX()
end
