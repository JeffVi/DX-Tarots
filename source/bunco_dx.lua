...
function load_bunco_dx_cu_consumables()
    ...
    G.P_CENTERS.c_bunc_Quaoar_dx =      {order = 13,    discovered = true, cost = 5, consumeable = true, freq = 1, name = "Quaoar DX", pos = {x=0,y=0}, set = "Planet", effect = "Hand Upgrade", cost_mult = 1.0, config = {type = '_dx', hand_type = 'bunc_Spectrum', softlock = true}, atlas = 'bunco_planets_dx'}
    G.P_CENTERS.c_bunc_Haumea_dx =      {order = 14,    discovered = true, cost = 5, consumeable = true, freq = 1, name = "Haumea DX", pos = {x=1,y=0}, set = "Planet", effect = "Hand Upgrade", cost_mult = 1.0, config = {type = '_dx', hand_type = 'bunc_Straight Spectrum', softlock = true}, atlas = 'bunco_planets_dx'}
    G.P_CENTERS.c_bunc_Sedna_dx =       {order = 15,    discovered = true, cost = 5, consumeable = true, freq = 1, name = "Sedna DX", pos = {x=2,y=0}, set = "Planet", effect = "Hand Upgrade", cost_mult = 1.0, config = {type = '_dx', hand_type = 'bunc_Spectrum House', softlock = true}, atlas = 'bunco_planets_dx'}
    G.P_CENTERS.c_bunc_Makemake_dx =    {order = 16,    discovered = true, cost = 5, consumeable = true, freq = 1, name = "Makemake DX", pos = {x=3,y=0}, set = "Planet", effect = "Hand Upgrade", cost_mult = 1.0, config = {type = '_dx', hand_type = 'bunc_Spectrum Five', softlock = true}, atlas = 'bunco_planets_dx'}
